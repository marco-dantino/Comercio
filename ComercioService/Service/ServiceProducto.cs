...
namespace ComercioService.Service
{
    public class ServiceProducto
    {
        ...
        public void agregar(Producto producto)
        {
            ...
            try
            {
                datos.setearConsulta("INSERT into productos (nombre, stock_actual, precio_compra, porcentaje_ganancia, id_marca, id_categoria, activo) values (@nombre, @stock_actual, @precio_compra, @porcentaje_ganancia, @id_marca, @id_categoria, @activo)");
        ...
        public void modificar(Producto producto)
        {
            ...
            try
            {
                datos.setearConsulta("UPDATE PRODUCTOS SET nombre = @nombre, stock_actual = @stock_actual, precio_compra = @precio_compra, porcentaje_ganancia = @porcentaje_ganancia, id_marca = @id_marca, id_categoria = @id_categoria, activo = @activo WHERE id = @id");
