                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            <div class="actions flex justify-left gap-4">
                                ...
                                <!-- Botón Eliminar -->
                                <asp:LinkButton ID="btnPDF" runat="server" CommandName="PDF" CommandArgument='<%# Eval("NumeroFactura") %>' CausesValidation="false" CssClass="material-icons-outlined text-red-500">
                                    picture_as_pdf
                                </asp:LinkButton>
