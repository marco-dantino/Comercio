<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Comercio.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold">Compra Nueva</h1>
        ...
        <div class="bg-[#1f2937] rounded-lg shadow-md p-6 mb-8 text-left space-y-6">
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div>
                    <label for="txtFecha" class="block mb-1 font-medium">Fecha</label>
                    <asp:TextBox ID="txtFecha" runat="server" CssClass="w-full bg-[#111827] border border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500" TextMode="Date"/>
                    <asp:RequiredFieldValidator ID="rfvFecha" runat="server" ControlToValidate="txtFecha" ErrorMessage="La Fecha es obligatoria." CssClass="text-red-400 text-sm" Display="Dynamic" />
                </div>
                ...
                <div>
                    <label for="ddlProducto" class="block mb-1 font-medium">Producto</label>
                    ...
                    <asp:RequiredFieldValidator ID="rfvProducto" runat="server" ControlToValidate="ddlProducto" InitialValue="" ErrorMessage="El Producto es requerido." CssClass="text-red-400 text-sm" Display="Dynamic" />
                </div>

                <div>
                    <label for="txtCantidad" class="block mb-1 font-medium">Cantidad</label>
                    ...
                    <asp:RequiredFieldValidator ID="rfvCantidad" runat="server" ControlToValidate="txtCantidad" ErrorMessage="La cantidad es obligatoria." CssClass="text-red-400 text-sm" Display="Dynamic" />
                    <asp:RegularExpressionValidator ID="revCantidad" runat="server" ControlToValidate="txtCantidad" ErrorMessage="Debe ser un número válido." CssClass="text-red-400 text-sm" Display="Dynamic" ValidationExpression="^\d+(\.\d{1,2})?$" />
                </div>
